...
public:
	...
	uint32_t		reserved() const						INLINE { return fields.sdk; }
	void			set_reserved(uint32_t value)			INLINE { E::set32(fields.sdk, value); }

	uint32_t		sdk() const								INLINE { return fields.sdk; }
	void			sdk(uint32_t value)						INLINE { E::set32(fields.sdk, value); }
